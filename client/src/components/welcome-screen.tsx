...
export default function WelcomeScreen() {
  ...
  return (
    <div className="max-w-md mx-auto px-4 pt-10 pb-12 text-center">
      <div className="mb-8">
        <div className="w-full h-64 rounded-xl shadow-md bg-gradient-to-br from-blue-100 via-blue-50 to-blue-50 flex items-center justify-center">
      ...
      <div className="space-y-4">
        <Button
          className="w-full bg-blue-500 hover:bg-blue-600 text-white py-3 px-4 rounded-xl font-medium shadow-md"
