...
export default function StudentDashboard() {
  ...
  const examplePathway: CareerPathway = {
    steps: [
      ...
      },
      {
        ...
        description:
          "Advanced position leading projects and mentoring juniors.",
        duration: "Ongoing",
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 mt-10 lg:px-8 py-6">
      <div className="mb-6">
