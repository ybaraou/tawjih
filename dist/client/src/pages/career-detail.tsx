    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 text-center">
        ...
        <p className="text-gray-600 mb-6">
          {t("career_not_found_description")}
        </p>
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
        <div>
          ...
          <div className="flex items-center space-x-2 text-gray-600">
            ...
            <span>•</span>
            <span>
              {t("job_prospects")}: {career.jobProspects}
            </span>
          </div>
        </div>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {skillsRequired.map((skill: string, index: number) => (
                    <Badge
                      key={index}
                      variant="outline"
                      className="bg-gray-100 text-gray-800 py-1.5"
                    >
                      {t(skill.toLowerCase())}
                    </Badge>
                  ))}
              ...
              <ScrollArea className="h-64">
                <div className="space-y-4">
                  <SimilarCareerCard
                    ...
                    skills={
                      career.title === t("software_engineer")
                        ...
                        : career.title === t("data_scientist")
                        ? [t("python"), t("algorithms"), t("statistics")]
                        : [
                            t("communication"),
                            t("organization"),
                            t("leadership"),
                  ...
                  <SimilarCareerCard
                    ...
                    skills={
                      career.title === t("software_engineer")
                        ? [t("swift"), t("kotlin"), t("react_native")]
                        : career.title === t("data_scientist")
                        ? [t("excel"), t("sql"), t("visualization")]
                  ...
                  <SimilarCareerCard
                    ...
                    skills={
                      career.title === t("software_engineer")
                        ? [t("linux"), t("docker"), t("kubernetes")]
                        : career.title === t("data_scientist")
                        ? [t("sql"), t("database_design"), t("backup")]
                        : [
                            t("recruitment"),
                            t("employee_relations"),
      ...
      <div className="flex justify-between mb-1">
        <div className="flex items-center">
          ...
          {isStrength ? (
            ...
            <Badge
              variant="outline"
              className="ml-2 bg-yellow-100 text-yellow-700 text-xs"
            >
              {t("growth_area")}
            </Badge>
          )}
      ...
      <div className="w-full bg-gray-200 rounded-full h-1.5 mb-1">
        <div
          className={`h-1.5 rounded-full ${
            isStrength ? "bg-green-500" : "bg-yellow-500"
          }`}
          style={{ width: `${value}%` }}
        ></div>
      </div>
...
function SimilarCareerCard({
  title,
  matchPercentage,
  skills,
}: SimilarCareerCardProps) {
  const { t } = useTranslation();
  const [location, navigate] = useLocation();

  return (
    <div className="p-3 border border-gray-200 rounded-lg hover:border-blue-200 hover:shadow-sm transition-all">
      ...
      <Button
        ...
        onClick={() =>
          navigate(`/career/${title.toLowerCase().replace(/\s+/g, "-")}`)
        }
      >
        {t("explore")} &rarr;
      </Button>
